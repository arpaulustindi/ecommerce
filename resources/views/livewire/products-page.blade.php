      ...
      <div class="px-4 py-4 mx-auto max-w-7xl lg:py-6 md:px-6">
        <div class="flex flex-wrap mb-24 -mx-3">
          <div class="w-full pr-2 lg:w-1/4 lg:block">
            ...
            <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
              <h2 class="text-2xl font-bold dark:text-gray-400">Produk Status</h2>
              <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
              <ul>
                ...
                <li class="mb-4">
                  <label for="featured" class="flex items-center dark:text-gray-300">
                    ...
                    <span class="text-lg dark:text-gray-400">Produk Akan Datang</span>
                  </label>
                </li>
                ...
                <li class="mb-4">
                  <label for="on_sale" class="flex items-center dark:text-gray-300">
                    ...
                    <span class="text-lg dark:text-gray-400">Dijual</span>
                  </label>
                </li>
            ...
            <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
              ...
              <div>
                ...
                <div class="flex justify-between">
                  <span class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(10000, 'Rp.') }}</span>
                  <span class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(10000000, 'Rp.') }}</span>
                </div>
              </div>
            </div>
                ...
                <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key="{{ $product->id }}">
                  <div class="border border-gray-300 dark:border-gray-700">
                    ...
                    <div class="p-3">
                      ...
                      <p class="text-lg">
                        <span class="text-green-600 dark:text-green-600">{{ Number::currency($product->price, 'Rp.') }}</span>
                      </p>
                    </div>
                    <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                      ...
                      <a wire:click.prevent='addToCart({{ $product->id }})' href="#" class="flex items-center space-x-2 text-gray-500 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-300">
                        ...
                        </svg><span>Tambah Kerjanjang</span>
                      </a>
